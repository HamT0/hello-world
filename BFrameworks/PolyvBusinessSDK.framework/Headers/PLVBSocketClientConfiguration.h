...
/// 登陆Socket的保利威用户账号信息，用于获取chatToken
...
/// 聊天室用户类型字符串，socket登陆时需要用到
@property (nonatomic, strong, readonly) NSString *userTypeString;

/// 聊天室用户连麦ID
/// userType为PLVBSocketUserTypeViewer时，连麦ID与viewerId一致；
/// userType不为PLVBSocketUserTypeViewer时，根据时间戳生成32位整数字符串
