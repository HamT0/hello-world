...
- (CVPixelBufferRef)copyI420BufferToNv12:(int)width height:(int)height yData:(char *)yData uData:(char *)uData vData:(char *)vData yStride:(int)yStride uStride:(int)uStride vStride:(int)vStride;
