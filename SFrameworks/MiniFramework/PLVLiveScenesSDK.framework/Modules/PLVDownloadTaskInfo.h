...
NS_INLINE NSString * _Nonnull NSStringFromPLVDownloadState(PLVDownloadState state) {
    NSString * string;
    switch (state) {
        case PLVDownloadStateDefault:{string = @"默认"; }break;
            
        case PLVDownloadStatePreparing:{string = @"准备中"; }break;
        case PLVDownloadStatePrepared:{string = @"已准备"; }break;
            
        case PLVDownloadStateWaiting:{string = @"等待中"; }break;
        case PLVDownloadStateDownloading:{string = @"下载中"; }break;
            
        case PLVDownloadStateUnzipping:{string = @"正在解压"; }break;
        case PLVDownloadStateUnzipped:{string = @"解压结束"; }break;

        case PLVDownloadStateStopped:{string = @"已停止"; }break;
        case PLVDownloadStateSuccess:{string = @"下载成功"; }break;
        case PLVDownloadStateFailed:{string = @"下载失败"; }break;
            
        default:{string = @"未知"; }break;
    }
    return string;
}
