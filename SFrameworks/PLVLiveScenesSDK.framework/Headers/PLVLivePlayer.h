...
@protocol PLVLivePlayerDelegate, PLVLivePlayerPictureInPictureDelegate;
...
/// 开启或退出 无延迟观看模式
///
/// @note 该方法只支持无延迟或快直播频道(即 [channelWatchNoDelay]为YES时 或 [channelWatchQuickLive]为YES时)；
